...
var posterPages = [];
var releaseUrl = [];
var moviePages = [ //specific for japan movies
    38,
    58,
    57,
    57,
        ...
        function (callback) {
            ...
            async.whilst(
                ...
                function (innercallback) {  
                    url = 'http://maoyan.com/films?sourceId=6&yearId='+(11-count)+'&offset='+(innerCount*30)+'&sortId=1';
                    request({
                        url: url,   
                        encoding: "utf8",
                        method: "GET"
                        ...
                        async.whilst(
                            ...
                            function(callback) {
                                dbJapan.japan.findOne({'title': title[thirdCount]}, function(err, doc){
                                    if (doc) {
                                        dbJapan.japan.update({'title': title[thirdCount]}, {'$set': {
